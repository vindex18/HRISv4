...
CREATE TABLE `attendance` (
  ...
  `for_change` tinyint(1) NOT NULL DEFAULT '0'
...
INSERT INTO `calendar` (`datefield`, `type`) VALUES
('2010-01-01', 4),
('2010-01-02', 5),
('2010-01-03', 6),
('2010-01-04', 0),
...
(1, 'Neil Daryl', 'Reyes', 'Sulit', '0945-362-7267', 'neil@invento.io', '667 Sucat, Muntinlupa City', 'Junior Web Developer', '$2y$10$Ry6TpxJLv9Re4swyS.9FDO.NWy3ettYe4JPhg3F5UqDT3T6XKwhS6', 1, '2018-06-10 11:05:19', '2018-06-10 11:05:19', 1, '2018-06-04'),
(2, 'Master Ivan Roir', 'Sermonia', 'Bruselas', '0945-362-7267', 'ivan@invento.io', 'Las Piñas', 'Junior Web Developer', '$2y$10$PEh822mrby5W3A0cvqJWt.dNBLCLLfYuQ67TXGwOMpNsWlDGWIcDe', 0, '2018-06-20 10:20:44', '2018-06-20 15:59:00', 1, '2018-06-04'),
(3, 'Jan Myckel', 'Labayog', 'Perez', '0929-208-6707', 'jan@invento.io', 'Las Piñas City', 'Junior Web Developer', '$2y$10$PEh822mrby5W3A0cvqJWt.dNBLCLLfYuQ67TXGwOMpNsWlDGWIcDe', 0, '2018-06-13 10:46:02', '2018-06-13 10:46:02', 1, '2018-06-11'),
(4, 'Camille', '', 'Cuisia', '0945-362-7267', 'cam@invento.io', 'Las Piñas', 'Web Designer', '$2y$10$2Li9VaAlUyU44rbdqeTba.R8Ka2oSgfUlHSXvBfjjcD7rgpn7VBzq', 0, '2018-06-13 10:46:02', '2018-06-13 10:46:02', 1, '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `employees_img`
--

CREATE TABLE `employees_img` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `employees_img`
--
ALTER TABLE `employees_img`
  ADD PRIMARY KEY (`id`);
